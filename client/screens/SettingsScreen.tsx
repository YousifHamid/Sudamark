            ...
            [
                { text: isRTL ? "إلغاء" : "Cancel", style: "cancel" },
                {
                    ...
                    onPress: () => {
                        ...
                        Alert.alert(isRTL ? "تم الحذف" : "Deleted", isRTL ? "تم حذف حسابك بنجاح." : "Your account has been deleted.");
                    }
                }
            ]
        );
            ...
            >
                <View style={[styles.section, { backgroundColor: theme.backgroundSecondary }]}>
                    ...
                    <View style={[styles.row, isRTL && styles.rowRTL]}>
                        ...
                        <Pressable onPress={handleLanguageChange} style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <ThemedText style={{ color: theme.primary, marginHorizontal: Spacing.xs }}>
                ...
                <View style={[styles.section, { backgroundColor: theme.backgroundSecondary, marginTop: Spacing.lg }]}>
                    <ThemedText type="h4" style={[styles.sectionTitle, isRTL && styles.rtlText]}>
